/**
 * Shared PDF layout engine (A4) for WCM release artifacts.
 *
 * Runtime-agnostic: it renders into an already-created pdfkit document whose
 * Unicode fonts have already been registered under the names exported here.
 * The Node release pipeline and the in-app (browser) document distribution
 * therefore produce byte-identical layout from the same block model.
 */
import { spansToPlainText } from './markdown.mjs';

export const MARGIN = 56; // ~2 cm
export const FONT = 'DejaVu';
export const FONT_BOLD = 'DejaVu-Bold';
export const FONT_ITALIC = 'DejaVu-Italic';
export const FONT_MONO = 'DejaVu-Mono';
export const FONT_MONO_BOLD = 'DejaVu-Mono-Bold';
...
/**
 * Render cover, body and per-page footers into `doc`. Does not call doc.end().
 */
export function renderPdfContent(doc, { blocks, meta }) {
