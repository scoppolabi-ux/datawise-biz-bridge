...
export const BOOKS = [
  {
    ...
    sections: [
      ...
      { title: 'PARTE VIII — Come processi e protocolli lavorano insieme', chapters: [
        chapter(49, 'Il WCM non è una sequenza lineare'),
        chapter(50, 'La matrice Processi × Protocolli'),
        chapter(51, 'La mappa dei nodi procedurali'),
      ]},
      { title: 'PARTE IX — I loop fondamentali del WCM', chapters: [
        chapter(52, 'Operational Loop'), chapter(53, 'Memory Loop'), chapter(54, 'Immune Loop'),
        chapter(55, 'Learning Loop'), chapter(56, 'Documentation Continuity Loop'), chapter(57, 'Il ciclo completo'),
      ]},
      { title: 'PARTE X — Determinismo e cognizione', chapters: [
        chapter(58, 'Dove serve l’AI e dove non deve essere usata'),
        chapter(59, 'Cognitive Core vs Deterministic Core'),
      ]},
      { title: 'PARTE XI — Perché questa architettura è interessante', chapters: [
        chapter(60, 'I punti di forza'),
        chapter(61, 'Dove sta l’originalità dell’approccio WCM'),
        chapter(62, 'Limiti e maturità attuale'),
      ]},
    ],
    appendices: [
