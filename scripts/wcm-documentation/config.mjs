...
export const BOOKS = [
  {
    ...
    sections: [
      ...
      { title: 'PARTE III — La memoria non è un archivio: è una rete', chapters: [
        chapter(7, 'L’architettura a nodi'), chapter(8, 'Le sinapsi: le relazioni tra i nodi'),
      ]},
      ...
      { title: 'PARTE VII — Il Libro dei Protocolli WCM', chapters: [
        chapter(28, 'Processo vs Protocollo'),
        chapter(29, 'PROT-001 — Git & Working Tree Safety'),
        chapter(30, 'PROT-002 — Result Acceptance & Closure'),
        chapter(31, 'PROT-003 — Direct Before Delegate'),
        chapter(32, 'PROT-004 — Canonical Dispatch & Idempotency'),
        chapter(33, 'PROT-005 — Index-First Progressive Retrieval'),
        chapter(34, 'PROT-006 — Branch Ownership & Baseline Sync'),
        chapter(35, 'PROT-007 — Decision Change & Impact Analysis'),
        chapter(36, 'PROT-008 — Owner Source Intake Gate'),
        chapter(37, 'PROT-009 — Contiguous Workflow Execution'),
        chapter(38, 'PROT-010 — Mission Control Authenticated Authority Command'),
        chapter(39, 'PROT-011 — Capability Evidence Check Before Block'),
        chapter(40, 'PROT-012 — Verified Email Delivery & Idempotency'),
        chapter(41, 'PROT-013 — Knowledge Synapse & Health Standard'),
        chapter(42, 'PROT-014 — Method Experience Memory Standard'),
        chapter(43, 'PROT-015 — Documentation Impact & Publication Standard'),
        chapter(44, 'PROT-016 — Deterministic State & Projection Contract'),
        chapter(45, 'PROT-017 — Persistent Mutation Safety'),
        chapter(46, 'PROT-018 — Internal Async Dependency Resolution'),
      ]},
      { title: 'PARTE VIII — Come processi e protocolli lavorano insieme', chapters: [
        chapter(47, 'Il WCM non è una sequenza lineare'),
        chapter(48, 'La matrice Processi × Protocolli'),
        chapter(49, 'La mappa dei nodi procedurali'),
      ]},
      { title: 'PARTE IX — I loop fondamentali del WCM', chapters: [
        chapter(50, 'Operational Loop'), chapter(51, 'Memory Loop'), chapter(52, 'Immune Loop'),
        chapter(53, 'Learning Loop'), chapter(54, 'Documentation Continuity Loop'), chapter(55, 'Il ciclo completo'),
      ]},
      { title: 'PARTE X — Determinismo e cognizione', chapters: [
        chapter(56, 'Dove serve l’AI e dove non deve essere usata'),
        chapter(57, 'Cognitive Core vs Deterministic Core'),
      ]},
      { title: 'PARTE XI — Perché questa architettura è interessante', chapters: [
        chapter(58, 'I punti di forza'),
        chapter(59, 'Dove sta l’originalità dell’approccio WCM'),
        chapter(60, 'Limiti e maturità attuale'),
      ]},
    ],
    appendices: [
